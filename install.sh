...
sudo updatedb
sudo apt-get update
sudo apt-get install php-dev php-gd -y
apt-get install php-geoip php-fpm mcrypt php-mcrypt phpenmod mcrypt -y
apt-get install apache2 apache2-mpm-prefork apache2-utils libapache2-mod-php5 libapr1 libaprutil1 libdbd-mysql-perl libdbi-perl libnet-daemon-perl libplrpc-perl libpq5 mysql-client-5.5 mysql-common mysql-server mysql-server-5.5 php5-common php5.6-mysql -y
